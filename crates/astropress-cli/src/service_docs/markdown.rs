...
pub(crate) fn build_services_doc(f: &AllFeatures) -> Option<String> {
    ...
    if f.payments == PaymentChoice::HyperSwitch {
        doc.push_str(concat!(
            ...
            "```\n\n",
            "**Connect payment providers** — open the HyperSwitch dashboard and go to **Connectors**:\n\n",
            "| Region | Provider | Methods |\n",
            "|--------|----------|---------|\n",
            "| East Africa | Safaricom M-Pesa (Daraja) | STK Push (phone → PIN prompt), C2B, B2C |\n",
            ...
            "For each connector, enter the credentials from that provider's dashboard and save.\n\n",
            ...
            "- **M-Pesa**: phone-number field → Safaricom STK Push — user receives a PIN prompt on their\n",
            "  phone and confirms the payment without leaving the page.\n",
            "- **UPI**: VPA (UPI ID) field + collect flow — works with Razorpay, Cashfree, PayU, PhonePe.\n",
