...
const BASH_COMPLETION: &str = r#"# astropress bash completion
...
const ZSH_COMPLETION: &str = r#"#compdef astropress
...
const FISH_COMPLETION: &str = r#"# astropress fish completion
...
# completions
complete -c astropress -n "__fish_seen_subcommand_from completions" -a "bash zsh fish" -d "Shell"
"#;
