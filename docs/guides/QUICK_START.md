...
- Node.js 24.8+ (required for the supported Astropress runtime and CLI toolchain)

The bundled repo installer provisions all prerequisites automatically from a local checkout:
