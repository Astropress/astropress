...
```ts
function resolvePublicPreviewLink(params: { baseUrl: URL; path: string | null | undefined; siteUrl: string | null | undefined; publicRendererPresent: boolean; }): PublicPreviewLink
```
