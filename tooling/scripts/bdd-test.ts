...
const verificationGroups: VerificationGroup[] = [
		...
		steps: [
			{
				...
				args: [
					"vitest",
					"run",
					"tests/wordpress-import.contract.test.ts",
					"tests/wordpress-import-branches.test.ts",
				],
				cwd: astropressPackageRoot,
			},
			{
	...
	},
	{
		...
		scenarios: ["Operator exports a project snapshot and restores it cleanly"],
		steps: [
			{
				command: "cargo",
		...
		steps: [
			{
				...
				args: [
					"vitest",
					"run",
					"tests/newsletter-adapter.test.ts",
					"tests/newsletter-subscribe.test.ts",
		...
		steps: [
			{
				...
				args: [
					"vitest",
					"run",
					"tests/deploy-targets.test.ts",
					"tests/deployment-matrix.test.ts",
					"tests/deploy-and-sync.contract.test.ts",
	...
	},
	{
		...
		scenarios: ["Dashboard displays site activity summary on first load"],
		steps: [
			{
				command: "bunx",
		...
		steps: [
			{
				...
				args: [
					"vitest",
					"run",
					"tests/html-sanitization.test.ts",
					"tests/html-optimization.test.ts",
				],
				cwd: astropressPackageRoot,
			},
		],
		...
		steps: [
			{
				...
				args: [
					"vitest",
					"run",
					"tests/locale-links.test.ts",
					"tests/translation-repository-factory.test.ts",
				],
				cwd: astropressPackageRoot,
			},
		],
		...
		steps: [
			{
				...
				args: [
					"vitest",
					"run",
					"tests/auth-repository-factory.test.ts",
					"tests/user-repository-factory.test.ts",
		...
		steps: [
			{
				...
				args: [
					"vitest",
					"run",
					"tests/public-site-integration.test.ts",
					"tests/aeo-metadata.test.ts",
				],
				cwd: astropressPackageRoot,
			},
		],
...
const unknownScenarioTitles = [...coveredScenarioTitles].filter(
	(title) => !featureScenarioTitles.has(title),
);
...
console.log(
	`BDD execution passed for ${scenarios.length} scenarios across ${verificationGroups.length} verification groups.`,
);
