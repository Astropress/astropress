...
export const POST: APIRoute = async (context) =>
  withAdminFormAction(context, { failurePath: "/wp-admin/settings", requireAdmin: true }, async ({ actor, formData, locals, redirect, fail }) => {
    ...
    return redirect("/wp-admin/settings?saved=1");
  });
