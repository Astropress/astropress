...
export const POST: APIRoute = async (context) =>
  withAdminFormAction(context, { failurePath: "/wp-admin/system", requireAdmin: true }, async ({ actor, formData, locals, redirect, fail }) => {
    ...
    return redirect("/wp-admin/system?saved=1");
  });
