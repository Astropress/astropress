...
export function createRuntimeFixture(): RuntimeFixture {
	...
	).run("group-sitemap", "system", "generated_xml", "en", "/sitemap.xml");
	db.prepare(
	...
	db.prepare(
		"INSERT INTO cms_route_groups (id, kind, render_strategy, canonical_locale, canonical_path) VALUES (?, ?, ?, ?, ?)",
	).run("group-es-feed", "system", "generated_xml", "es", "/es/feed.xml");
	db.prepare(
		"INSERT INTO cms_route_variants (id, group_id, locale, path, status, title, settings_json, updated_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
	).run(
		"variant-es-feed",
	...
	db.prepare(
		"INSERT INTO cms_route_groups (id, kind, render_strategy, canonical_locale, canonical_path) VALUES (?, ?, ?, ?, ?)",
	).run("group-robots", "system", "generated_text", "en", "/robots.txt");
	db.prepare(
		"INSERT INTO cms_route_variants (id, group_id, locale, path, status, title, settings_json, updated_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
	).run(
		"variant-robots",
	...
	db.prepare(
		"INSERT INTO cms_route_groups (id, kind, render_strategy, canonical_locale, canonical_path) VALUES (?, ?, ?, ?, ?)",
	).run("group-page-num", "page", "structured_sections", "en", "/numeric-key");
	db.prepare(
		"INSERT INTO cms_route_variants (id, group_id, locale, path, status, title, settings_json, updated_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
	).run(
		"variant-page-num",
	...
	db.prepare(
		"INSERT INTO cms_route_groups (id, kind, render_strategy, canonical_locale, canonical_path) VALUES (?, ?, ?, ?, ?)",
	).run("group-page-str", "page", "structured_sections", "en", "/string-key");
	db.prepare(
