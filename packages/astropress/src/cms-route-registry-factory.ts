...
export function createAstropressCmsRouteRegistry(input: AstropressCmsRouteRegistryFactoryInput) {
	return {
		...
		saveStructuredPageRoute: (pathname: string, rawInput: StructuredPageInput, actor: RouteActor) =>
		...
		saveArchiveRoute: (pathname: string, rawInput: ArchiveRouteInput, actor: RouteActor) =>
