...
export async function saveCredentialsFile(filePath: string, config: CredentialsFile): Promise<void> {
  try {
...
function requireField(obj: Record<string, unknown>, field: string, context: string): string {
