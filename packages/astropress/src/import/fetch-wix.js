...
export class WixInvalidCredentialsError extends Error {
  name = "WixInvalidCredentialsError";
  constructor() {
...
export class WixTwoFactorRequiredError extends Error {
  name = "WixTwoFactorRequiredError";
  constructor() {
...
async function attemptWixExport(opts) {
  ...
  try {
    ...
    await page.goto("https://users.wix.com/signin", { timeout: timeoutMs, waitUntil: "domcontentloaded" });
    ...
    if (postLoginUrl.includes("signin") || !postLoginUrl.includes("manage.wix.com")) {
...
export async function fetchWixExport(opts) {
