...
import { deriveLegacyProvider, appHostToDeployTarget, baseLocalEnv, baseEnvExample, buildDataServiceExample, buildAnalyticsEnvExample, buildAbTestingEnvExample, buildHeatmapEnvExample, buildApiEnvExample, buildDonationsEnvExample, } from "./project-scaffold-env.js";
import { createPackageScripts, createCiFiles, createDeployDoc } from "./project-scaffold-ci.js";
...
export function createAstropressProjectScaffold(input = "sqlite") {
    ...
    const recommendationRationale = matrixEntry?.notes ??
