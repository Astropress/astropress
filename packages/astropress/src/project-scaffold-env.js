import { createLocalBootstrapSecrets } from "./project-scaffold-passphrase.js";
export function deriveLegacyProvider(dataServices) {
...
export function defaultAdminDbPath(provider) {
...
export function appHostToDeployTarget(appHost) {
    return appHost === "cloudflare-pages" ? "cloudflare" : appHost;
}
export function defaultServiceOrigin(dataServices) {
    switch (dataServices) {
...
export function baseLocalEnv(provider, appHost, dataServices) {
    return {
...
export function baseEnvExample(provider, appHost, dataServices) {
    return {
        ASTROPRESS_APP_HOST: appHost,
        ASTROPRESS_CONTENT_SERVICES: dataServices,
        ADMIN_DB_PATH: defaultAdminDbPath(provider),
...
export function buildDataServiceExample(dataServices) {
...
export function buildAnalyticsEnvExample(analytics) {
    switch (analytics) {
...
export function buildAbTestingEnvExample(abTesting) {
    switch (abTesting) {
...
export function buildHeatmapEnvExample(heatmap) {
    switch (heatmap) {
...
export function buildApiEnvExample() {
