...
import {
	...
	SQL_UPSERT_MEDIA,
} from "./sqlite-helpers-data.js";

// Re-export so existing `from "./sqlite-helpers"` importers stay unaffected.
export { SQL_INSERT_REVISION, SQL_LIST_TRANSLATIONS, SQL_UPSERT_MEDIA };
