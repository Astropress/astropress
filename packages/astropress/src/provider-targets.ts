import { normalizeProviderCapabilities, type ProviderCapabilities, type ProviderKind } from "./platform-contracts";
...
const firstPartyProviderTargets: Record<ProviderKind, FirstPartyProviderTarget> = {
  "github-pages": {
    id: "github-pages",
    label: "GitHub Pages",
    runtime: "static",
