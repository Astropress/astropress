---
title: Quick start
description: Get a working Astropress site with an admin panel in under 5 minutes.
---

## Prerequisites

- [Bun](https://bun.sh) 1.3+
- Node.js 24.8+ (required for `node:sqlite`, used by the Astropress CLI)
...
The host app must alias `local-runtime-modules` in `astro.config.mjs` to its own runtime implementation.

## Next steps

| Topic | Doc |
|-------|-----|
| Deploy admin + public site separately | [Two-site deployment](/guides/two-site-deploy/) |
| Analytics, consent banner, custom snippets | [Analytics](/guides/analytics/) |
| Built-in web components and how to extend them | [Web components](/reference/web-components/) |
| Import from WordPress or Wix; content scheduling | [Operations](/guides/operations/) |
| GDPR data inventory and right of erasure | [Compliance](/guides/compliance/) |
| Multilingual sites and admin UI labels | [Multilingual sites](/guides/multilingual/) |
