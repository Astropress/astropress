...
title: Analytics
description: >-
  Add first-party, self-hosted analytics — opt-in and off by default, with
  consent-aware snippet injection.
---
...
:::note
If you haven't chosen an analytics provider yet, see [Analytics options](/integrations/search/) for a comparison of Umami, Plausible, Matomo, and PostHog with tradeoffs and setup costs.
:::
