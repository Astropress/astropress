...
Astropress ships with its own session-based admin authentication — bcrypt passwords, 12-hour sessions, CSRF protection, and rate-limited login. **You do not need to add SSO to use the admin panel.**
